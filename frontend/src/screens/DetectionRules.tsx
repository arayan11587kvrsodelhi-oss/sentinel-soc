...
const rules = [
  {
    ...
    description:
      "Detects credential brute force and password spray attacks with successful login correlation",
...

  {
    ...
    description:
      "Detects suspicious PowerShell execution with encoded commands or unusual parent processes",
...

  {
    ...
    description:
      "Detects port scanning and network discovery activity from internal sources",
...

  {
    ...
    description:
      "Identifies lateral movement via SMB and administrative shares",
...

  {
    ...
    description:
      "Detects large outbound data transfers to external destinations",
          ...
          {rules.map((rule) => (
            <div
              ...
              style={{
                ...
                border: `1px solid ${
                  selectedRule.id === rule.id ? "#56B4FF40" : "#1D2938"
                }`,
              }}
            >
              <div className="flex items-start justify-between mb-2">
                <div>
                  <span
                    ...
                    style={{
                      color:
                        selectedRule.id === rule.id ? "#56B4FF" : "#9AA8B8",
                    }}
                  >
                    {rule.id}
                  </span>
                ...
                <button
                  ...
                  style={{
                    background: enabledStates[rule.id]
                      ? "#42D39240"
                      : "#1D2938",

                    border: `1px solid ${
                      enabledStates[rule.id] ? "#42D39260" : "#1D2938"
                    }`,
                  }}
                >
                  <div
          ...
          >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span
                    ...
                    style={{
                      ...
                      color: enabledStates[selectedRule.id]
                        ? "#42D392"
                        : "#627083",
                    }}
                  >
                    {enabledStates[selectedRule.id]
                      ? "● ENABLED"
                      : "○ DISABLED"}
                  </span>
                </div>
            ...
            >
              {[
                ...
                {
                  label: "Matches",
                  value: String(selectedRule.matches),
                  mono: false,
                },

                {
                  label: "Precision",
                  value: `${selectedRule.precision}%`,
                  mono: false,
                  color: "#42D392",
                },

                {
                  ...
                  mono: false,
                  color: sevColor[selectedRule.severity],
                },
              ].map((s) => (
                <div key={s.label}>
                  <div
                  ...
                  <div
                    ...
                    style={{
                      color: (s as { color?: string }).color ?? "#F4F7FA",
                    }}
                  >
                    {s.value}
                  </div>
            ...
            >
              <div
                ...
                style={{
                  ...
                  background:
                    selectedRule.precision >= 80
                      ? "#42D392"
                      : selectedRule.precision >= 60
                        ? "#F4C95D"
                        : "#FF4D5E",
                }}
              />
