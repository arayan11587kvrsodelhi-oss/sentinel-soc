            ...
            >
              ...
              >
                <span className="font-semibold" style={{ color: "#F4F7FA" }}>
                  High-confidence credential attack targeting an internal
                  authentication service.
                </span>{" "}
                The attack pattern is consistent with an automated password
                spraying campaign originating from a single internal IP address.
                The subsequent successful authentication and privileged resource
                access indicates probable account compromise. The attack
                timeline spans 17 seconds with 12 failed attempts across 4
                accounts before a successful login.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="space-y-2">
              {[
                {
                  point:
                    "12 failed authentication attempts in a 17-second window",
                  severity: "high",
                },

                {
                  point:
                    "4 distinct usernames targeted — consistent with spray pattern",
                  severity: "high",
                },

                {
                  point:
                    "All attempts originating from single IP: 192.168.1.42",
                  severity: "critical",
                },

                {
                  point:
                    "Successful login from same source IP immediately following failures",
                  severity: "critical",
                },

                {
                  point:
                    "Privileged endpoint accessed within 3 seconds of authentication",
                  severity: "critical",
                },

                {
                  point:
                    "47 user records returned from /api/admin/users — potential data exfil",
                  severity: "high",
                },
              ].map((item, i) => (
                <div key={i} className="flex items-start gap-2.5">
                  <div
                    ...
                    style={{
                      background:
                        item.severity === "critical" ? "#FF4D5E" : "#FF8A4C",
                    }}
                  />
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                style={{
                  ...
                  border: `1px solid ${
                    addedToInvestigation ? "#42D39230" : "#1D2938"
                  }`,
                }}
              >
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  ...
                  style={{
                    borderBottom: i < 8 ? "1px solid #1D293840" : "none",
                    paddingBottom: i < 8 ? "8px" : "0",
                  }}
                >
                  <span className="text-xs" style={{ color: "#627083" }}>
                    {item.label}
                  ...
                  <span
                    ...
                    style={{
                      color: (item as { color?: string }).color ?? "#F4F7FA",
                    }}
                  >
                    {item.value}
                  </span>
