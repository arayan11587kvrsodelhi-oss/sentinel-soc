...
const cveData = [
...

  {
    ...
    description:
      "Privilege escalation through Windows kernel driver vulnerability",
          ...
          <div className="grid grid-cols-2 gap-3">
            {filtered.map((cve) => (
              <div
                key={cve.id}
                onClick={() =>
                  setSelectedCve(selectedCve?.id === cve.id ? null : cve)
                }
                className="rounded-xl p-4 cursor-pointer transition-all"
                style={{
                  background:
                    selectedCve?.id === cve.id ? "#1A2333" : "#111925",

                  border: `1px solid ${
                    selectedCve?.id === cve.id ? "#56B4FF40" : "#1D2938"
                  }`,
                }}
              >
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div
                  ...
                  style={{
                    background: cvssColor(selectedCve.cvss) + "0A",
                    border: `1px solid ${cvssColor(selectedCve.cvss)}25`,
                  }}
                >
                  <div className="text-center">
                    <div
                      className="text-2xl font-semibold font-mono"
                      style={{ color: cvssColor(selectedCve.cvss) }}
                    >
                      {selectedCve.cvss}
                    </div>
                    <div className="text-[10px]" style={{ color: "#627083" }}>
                  ...
                  <div className="flex-1">
                    ...
                    >
                      <div
                        className="h-2 rounded-full"
                        style={{
                          width: `${(selectedCve.cvss / 10) * 100}%`,
                          background: cvssColor(selectedCve.cvss),
                        }}
                      />
                    </div>
                    <div
