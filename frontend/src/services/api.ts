...
export const api = {
  ...
  async getVulnerabilities(params?: {
    ...
    const url = `${API_BASE}/api/vulnerabilities${
      qs ? `?${qs}` : ""
    }`;
  ...
  async getKevCatalog(params?: {
    ...
    const url = `${API_BASE}/api/vulnerabilities/kev${
      qs ? `?${qs}` : ""
    }`;
  ...
  async getIncidents(params?: {
    ...
    const url = `${API_BASE}/api/incidents${
      qs ? `?${qs}` : ""
    }`;
  ...
  async getThreatEvents(params?: {
    ...
    const url = `${API_BASE}/api/threats${
      qs ? `?${qs}` : ""
    }`;
